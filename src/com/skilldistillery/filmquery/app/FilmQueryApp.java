			...
			case 2: //search film by keyword in either film's title or film's description
				...
				if (films.size() > 0) {
					...
					for (Film filmK : films) {
							//for every film in the array of films print out the printString and the language 

						System.out.println(
								filmK.printString() + "\nLanguage: " + db.findLanguageById(filmK.getLanguageId()));
							//for every actor in the array of actors print out the actors first and last name
						...
						//used to create a space between each movie and movie data and the next movie and movie data
						System.out.println();
						System.out.println();
